...
if (!fs.existsSync(process.cwd() + '/Haipocsting_database')) {
    fs.mkdirSync(process.cwd() + '/Haipocsting_database');
    fs.writeFileSync(process.cwd() + '/Haipocsting_database/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var db = new BetterDB(process.cwd() + "/Haipocsting_database/SyntheticDatabase.sqlite");
